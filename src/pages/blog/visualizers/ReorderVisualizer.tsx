...
import { getSolutions, REORDER_LINE_MAP } from '../../../data/solutions';
...
const SOLUTIONS_REORDER = getSolutions('reorder-list-143');
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 14 }}>
        <SolutionTabs
          solutions={SOLUTIONS_REORDER}
          defaultLang="csharp"
          getHighlight={(lang) => [REORDER_LINE_MAP[lang][step.type]]}
          meta="O(n) · O(1)"
        />
      </div>
    </div>
